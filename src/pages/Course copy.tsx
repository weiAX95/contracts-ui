            ...
            <div className="space-y-4">
                {courses.map((course) => (
                    ...
                    >
                        ...
                        <button className="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 focus:outline-none" onClick={() => purchaseCourse(course.id)}>
                            购买课程
                        </button>
                    </div>
                ))}
